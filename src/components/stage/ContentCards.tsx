...
const PROJECTS: Record<string, ProjectData> = {
  'meridian-money': {
    ...
    description: 'Envelope budgeting that actually makes sense. AI-optional, privacy-first, and a third of the price of YNAB. Your data stays yours.',
    details: [
      'Envelope budgeting with automatic bank sync via Stripe',
      'AI is optional — works great with zero AI, or add Plutus ($10/mo) for a real financial coach',
      'Bring Your Own AI via MCP server — connect Claude, ChatGPT, or any MCP client to your data',
      'Your data is 100% yours — no selling, no training AI on it, no lock-in',
